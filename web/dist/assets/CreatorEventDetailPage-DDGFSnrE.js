import{n as e,s as t,t as n}from"./jsx-runtime-BseJUIpC.js";import{l as r,n as i,u as a}from"./chunk-6CSD65Y2-BssU3dZc.js";import{t as o}from"./EmptyState-DFQr9n-N.js";import{t as s}from"./circle-check-CaMhNJBB.js";import{Cn as c,Dt as l,c as u,ct as d,gn as f,mt as p,pt as m}from"./index-sycuWGIH.js";import{t as h}from"./TextField-B2L9Dfzu.js";import{t as g}from"./Alert-6ucnecYY.js";import{t as _}from"./Modal-D976sXX9.js";import{t as v}from"./EngagementBadge-DL-IdvVb.js";import{h as y,n as b}from"./creator-BD7sF_lM.js";import{t as x}from"./Textarea-po8JxPZZ.js";import{n as S,t as C}from"./EventDetailBody-DMbCDPme.js";var w=t(e(),1),T={Fashion:[`Hi {brand} team!
...
Looking forward to the opportunity to collaborate!`,`Hello {brand}!
...
Excited to hear from you!`],Food:[`Hi {brand} team!
...
Looking forward to creating something delicious together!`,`Hello {brand}!
...
Can't wait to collaborate!`],Tech:[`Hi {brand} team!
...
Looking forward to working together!`,`Hello {brand}!
...
Excited about this collaboration!`],Technology:[`Hi {brand} team!
...
Looking forward to discussing further!`,`Hello {brand}!
...
Thank you for the opportunity!`],Beauty:[`Hi {brand} team!
...
Can't wait to create something beautiful together!`,`Hello {brand}!
...
Looking forward to this partnership!`],Travel:[`Hi {brand} team!
...
Excited about the possibility of exploring this together!`,`Hello {brand}!
...
Looking forward to hearing from you!`],Fitness:[`Hi {brand} team!
...
Let's build something strong together!`,`Hello {brand}!
...
Excited to collaborate!`],Gaming:[`Hi {brand} team!
...
Let's level up together!`,`Hello {brand}!
...
Looking forward to connecting!`],Music:[`Hi {brand} team!
...
Let's make something great together!`,`Hello {brand}!
...
Looking forward to collaborating!`],Education:[`Hi {brand} team!
...
Excited to teach and inspire together!`,`Hello {brand}!
...
Looking forward to this opportunity!`],Lifestyle:[`Hi {brand} team!
...
Looking forward to collaborating!`,`Hello {brand}!
...
Excited about this opportunity!`],Sports:[`Hi {brand} team!
...
Let's win together!`,`Hello {brand}!
...
Looking forward to this partnership!`],Wellness:[`Hi {brand} team!
...
Looking forward to this collaboration!`,`Hello {brand}!
...
Excited to connect!`]},E=[`Hi {brand} team!
...
Looking forward to discussing this opportunity with you!`,`Hello {brand}!
...
Excited about the possibility of working together!`,`Hi {brand} team!
...
Looking forward to hearing from you!`];function D(e,t,n){let r=T[e]??E;return r[Math.floor(Math.random()*r.length)].replace(/\{brand\}/g,n||`your team`).replace(/\{title\}/g,t||`this event`)}var O=n(),k=50,A=`2 weeks`;function j({event:e,open:t,onClose:n,onApplied:r}){let i=c(),a=e.campaignType===`OPEN_EVENT`,o=e.budgetMin===e.budgetMax,[s,d]=(0,w.useState)(()=>D(e.category,e.title,e.business?.businessName??``)),[m,v]=(0,w.useState)(``),[y,S]=(0,w.useState)(``),[C,T]=(0,w.useState)(``),[E,j]=(0,w.useState)({}),[M,N]=(0,w.useState)(!1),P=()=>{d(D(e.category,e.title,e.business?.businessName??``))},F=a?i(`creatorEvents.proposedRateHintFree`):o?i(`creatorEvents.proposedRateHintMax`,{max:e.budgetMax.toLocaleString(`en-IN`)}):i(`creatorEvents.proposedRateHintRange`,{min:e.budgetMin.toLocaleString(`en-IN`),max:e.budgetMax.toLocaleString(`en-IN`)});async function I(t){t.preventDefault(),T(``);let n={};s.trim().length<k&&(n.cover=i(`creatorEvents.coverLetterTooShort`));let c=a?0:Number(m);if(a||(!m.trim()||Number.isNaN(c)?n.rate=i(`creatorEvents.rateRequired`):o&&c>e.budgetMax?n.rate=i(`creatorEvents.rateTooHigh`,{max:e.budgetMax.toLocaleString(`en-IN`)}):!o&&(c<e.budgetMin||c>e.budgetMax)?n.rate=i(`creatorEvents.rateOutOfRange`,{min:e.budgetMin.toLocaleString(`en-IN`),max:e.budgetMax.toLocaleString(`en-IN`)}):c<=0&&(n.rate=i(`creatorEvents.rateRequired`))),j(n),!(Object.keys(n).length>0)){N(!0);try{r(await b(e.id,{coverLetter:s.trim(),proposedRate:c,timeline:A,portfolioUrl:y.trim()||void 0}))}catch(e){e instanceof f&&e.status===409?T(i(`creatorEvents.alreadyApplied`)):T(e instanceof Error?e.message:i(`common.somethingWrong`))}finally{N(!1)}}}return(0,O.jsx)(_,{open:t,onClose:n,title:i(`creatorEvents.proposalTitle`),size:`lg`,footer:(0,O.jsxs)(`div`,{className:`flex justify-end gap-2`,children:[(0,O.jsx)(p,{variant:`ghost`,onClick:n,disabled:M,children:i(`common.cancel`)}),(0,O.jsx)(p,{form:`apply-form`,type:`submit`,loading:M,children:i(`creatorEvents.submitProposal`)})]}),children:(0,O.jsxs)(`form`,{id:`apply-form`,onSubmit:I,noValidate:!0,className:`space-y-4`,children:[C&&(0,O.jsx)(g,{tone:`error`,children:C}),(0,O.jsx)(x,{label:i(`creatorEvents.coverLetter`),hint:i(`creatorEvents.coverLetterAutoHint`),error:E.cover,showCount:!0,rows:5,value:s,onChange:e=>d(e.target.value),labelAccessory:(0,O.jsxs)(`button`,{type:`button`,onClick:P,className:`inline-flex flex-shrink-0 items-center gap-1 text-[12.5px] font-semibold text-violet-dark hover:underline`,children:[(0,O.jsx)(l,{size:12}),i(`profile.regenerate`)]})}),!a&&(0,O.jsx)(h,{label:i(`creatorEvents.proposedRate`),type:`number`,inputMode:`numeric`,min:0,hint:F,error:E.rate,value:m,onChange:e=>v(e.target.value)}),a&&(0,O.jsx)(g,{tone:`info`,children:F}),(0,O.jsx)(h,{label:`${i(`creatorEvents.portfolioUrl`)} (${i(`common.optional`)})`,type:`url`,inputMode:`url`,placeholder:`https://`,value:y,onChange:e=>S(e.target.value)}),(0,O.jsx)(`p`,{className:`text-[12px] text-ink-soft`,children:a?``:`${i(`public.budgetPerCreatorLabel`)}: ${u(e.budgetMin)}${o?``:` – ${u(e.budgetMax)}`}`})]})})}function M(){let e=c(),t=r(),{id:n=``}=a(),l=m(e=>d(n,e),[n]),u=m(e=>y({limit:100},e),[]),[h,_]=(0,w.useState)(!1),[b,x]=(0,w.useState)(null);if(l.loading)return(0,O.jsx)(`div`,{className:`mx-auto max-w-4xl`,children:(0,O.jsx)(S,{})});if(l.error||!l.data)return(0,O.jsx)(`div`,{className:`mx-auto max-w-3xl py-10`,children:(0,O.jsx)(o,{variant:l.error instanceof f&&l.error.status===404?`not-found`:`error`,title:e(`public.eventNotFoundTitle`),description:e(`public.eventNotFoundBody`),action:{label:e(`public.backToEvents`),href:`/creator/events`}})});let T=l.data,E=b??(u.data?.items??[]).find(e=>e.campaignId===T.id)??null,D=(T.requirements?.length??0)>0,k=T.status===`ACTIVE`,A=T.campaignType===`OPEN_EVENT`,M;return M=E?(0,O.jsxs)(`div`,{className:`flex flex-wrap items-center gap-3 rounded-2xl border border-success/30 bg-success-soft/50 px-4 py-3`,children:[(0,O.jsx)(s,{size:18,className:`text-success`}),(0,O.jsx)(`span`,{className:`text-[14px] font-semibold text-ink`,children:e(`creatorEvents.alreadyApplied`)}),(0,O.jsx)(v,{state:E.engagementState}),(0,O.jsx)(i,{to:`/creator/applications`,className:`ml-auto text-[13px] font-semibold text-violet-dark hover:underline`,children:e(`creatorEvents.viewApplication`)})]}):k?D?(0,O.jsx)(`a`,{href:`/`,className:`inline-block`,children:(0,O.jsx)(p,{size:`lg`,children:e(`public.applyInApp`)})}):(0,O.jsx)(p,{size:`lg`,onClick:()=>_(!0),children:e(A?`creatorEvents.applyFree`:`creatorEvents.apply`)}):(0,O.jsx)(g,{tone:`info`,children:e(`creatorEvents.notAccepting`)}),(0,O.jsxs)(`div`,{className:`mx-auto max-w-4xl`,children:[(0,O.jsx)(C,{event:T,backTo:`/creator/events`,backLabel:e(`public.backToEvents`),cta:M}),b&&(0,O.jsxs)(`div`,{className:`mt-10 rounded-2xl border border-success/30 bg-success-soft/40 p-6 text-center`,children:[(0,O.jsx)(s,{size:28,className:`mx-auto text-success`}),(0,O.jsx)(`p`,{className:`mt-2 text-[15px] font-semibold text-ink`,children:e(`creatorEvents.proposalSent`)})]}),(0,O.jsx)(j,{event:T,open:h,onClose:()=>_(!1),onApplied:e=>{_(!1),x(e),u.reload(),t(`/creator/events/${T.id}`,{replace:!0})}})]})}export{M as CreatorEventDetailPage};