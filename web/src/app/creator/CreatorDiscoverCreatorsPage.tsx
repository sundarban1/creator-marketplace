...
import { CreatorCard } from '../public/CreatorCard';
...
export function CreatorDiscoverCreatorsPage() {
  ...
  const load = useCallback(
    async (nextPage: number, append: boolean) => {
      ...
      try {
        const res = await fetchPublicCreators({
  ...
  return (
    <>
      <DashPageHeader title={t('nav.discoverCreators')} description={t('creatorDiscover.creatorsSubtitle')} />
