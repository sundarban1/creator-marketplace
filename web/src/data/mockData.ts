...
export const recentActivity = [
  ...
  { id: '3', type: 'payment', text: 'Payment of Rs. 1,200 released to @fashionista', time: '1 hr ago', icon: 'payment' },
  ...
  { id: '7', type: 'payment', text: 'Payment of Rs. 850 released to @travelblogger', time: '6 hr ago', icon: 'payment' },
];
...
export const creators: Creator[] = [
  { id: 'c1', name: 'Alex Rivera', handle: '@alexrivera', avatar: 'AR', platform: 'Instagram', followers: '142K', engagement: '4.8%', category: 'Fashion', status: 'active', campaigns: 12, earnings: 'Rs. 8,400' },
  { id: 'c2', name: 'Mia Chen', handle: '@miachen', avatar: 'MC', platform: 'TikTok', followers: '890K', engagement: '6.2%', category: 'Lifestyle', status: 'active', campaigns: 24, earnings: 'Rs. 21,300' },
  { id: 'c3', name: 'Jordan Blake', handle: '@jordanblake', avatar: 'JB', platform: 'YouTube', followers: '320K', engagement: '3.1%', category: 'Tech', status: 'banned', campaigns: 5, earnings: 'Rs. 3,200' },
  { id: 'c4', name: 'Priya Sharma', handle: '@priyasharma', avatar: 'PS', platform: 'Instagram', followers: '75K', engagement: '7.4%', category: 'Beauty', status: 'active', campaigns: 9, earnings: 'Rs. 5,100' },
  { id: 'c5', name: 'Tyler James', handle: '@tylerjames', avatar: 'TJ', platform: 'YouTube', followers: '215K', engagement: '2.9%', category: 'Fitness', status: 'inactive', campaigns: 3, earnings: 'Rs. 1,800' },
  { id: 'c6', name: 'Sofia Ruiz', handle: '@sofiaruiz', avatar: 'SR', platform: 'TikTok', followers: '1.2M', engagement: '8.1%', category: 'Food', status: 'active', campaigns: 31, earnings: 'Rs. 44,700' },
  { id: 'c7', name: 'Marcus Lee', handle: '@marcuslee', avatar: 'ML', platform: 'Instagram', followers: '67K', engagement: '5.6%', category: 'Travel', status: 'active', campaigns: 7, earnings: 'Rs. 4,200' },
  { id: 'c8', name: 'Aisha Khan', handle: '@aishakhan', avatar: 'AK', platform: 'LinkedIn', followers: '28K', engagement: '9.3%', category: 'Business', status: 'active', campaigns: 4, earnings: 'Rs. 3,600' },
];

export const businesses: Business[] = [
  { id: 'b1', name: 'StyleCo Brand', email: 'hello@styleco.com', industry: 'Fashion', status: 'active', campaigns: 8, spent: 'Rs. 32,400', joinedAt: '2024-01-15', logo: 'SC' },
  { id: 'b2', name: 'TechGadgets Inc.', email: 'info@techgadgets.com', industry: 'Technology', status: 'inactive', campaigns: 3, spent: 'Rs. 9,800', joinedAt: '2024-02-10', logo: 'TG' },
  { id: 'b3', name: 'NovaBrands Inc.', email: 'contact@novabrands.com', industry: 'Retail', status: 'active', campaigns: 12, spent: 'Rs. 58,200', joinedAt: '2024-03-01', logo: 'NB' },
  { id: 'b4', name: 'FoodieHub Co.', email: 'team@foodiehub.com', industry: 'Food & Beverage', status: 'active', campaigns: 6, spent: 'Rs. 17,500', joinedAt: '2024-03-15', logo: 'FH' },
  { id: 'b5', name: 'UrbanWear Ltd.', email: 'admin@urbanwear.com', industry: 'Fashion', status: 'active', campaigns: 15, spent: 'Rs. 71,300', joinedAt: '2024-04-01', logo: 'UW' },
  { id: 'b6', name: 'GreenLife Corp.', email: 'info@greenlife.com', industry: 'Health & Wellness', status: 'active', campaigns: 5, spent: 'Rs. 14,900', joinedAt: '2024-04-12', logo: 'GL' },
  { id: 'b7', name: 'AutoParts Pro', email: 'sales@autopartspro.com', industry: 'Automotive', status: 'banned', campaigns: 1, spent: 'Rs. 2,100', joinedAt: '2024-04-20', logo: 'AP' },
];

export const campaigns: Campaign[] = [
  { id: 'cp1', title: 'Summer Collection Launch', business: 'StyleCo Brand', platform: 'Instagram', budget: 'Rs. 5,000', status: 'active', proposals: 18, deadline: '2024-07-30', category: 'Fashion' },
  { id: 'cp2', title: 'Tech Review Series', business: 'TechGadgets Inc.', platform: 'YouTube', budget: 'Rs. 3,200', status: 'completed', proposals: 7, deadline: '2024-06-15', category: 'Technology' },
  { id: 'cp3', title: 'Back to School Campaign', business: 'NovaBrands Inc.', platform: 'TikTok', budget: 'Rs. 8,500', status: 'active', proposals: 34, deadline: '2024-08-20', category: 'Retail' },
  { id: 'cp4', title: 'Foodie Friday Challenge', business: 'FoodieHub Co.', platform: 'Instagram', budget: 'Rs. 2,800', status: 'pending', proposals: 0, deadline: '2024-08-01', category: 'Food' },
  { id: 'cp5', title: 'Urban Street Style', business: 'UrbanWear Ltd.', platform: 'Instagram', budget: 'Rs. 12,000', status: 'active', proposals: 52, deadline: '2024-09-01', category: 'Fashion' },
