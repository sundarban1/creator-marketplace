        ...
        <div className="w-full max-w-md">
          ...
          <div className="mb-6 p-4 bg-indigo-50 border border-indigo-100 rounded-xl">
            ...
            <div className="space-y-1.5">
              <button
                onClick={(e) => fillDemo(e, 'admin@creatorhub.com', 'Admin@123456')}
              ...
              >
                admin@creatorhub.com / Admin@123456
              </button>
              <button
                onClick={(e) => fillDemo(e, 'moderator@creatorhub.com', 'Admin@123456')}
                className="w-full text-left text-xs text-indigo-600 hover:text-indigo-800 font-mono bg-white/70 hover:bg-white px-3 py-1.5 rounded-lg transition-colors"
              >
                moderator@creatorhub.com / Admin@123456
              </button>
            </div>
          </div>
