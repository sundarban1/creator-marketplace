...
const FAQS = [
  { q: 'Is kolab free to join?',               a: 'Yes — signing up is completely free for both creators and brands. We only charge a small platform fee when a campaign is successfully completed.' },
    ...
    <div className="min-h-screen bg-white font-sans">
      ...
      >
        ...
        >
          ...
          <motion.p variants={fadeUp} className="text-white/70 text-lg mb-8">Join thousands of creators and brands already using kolab.</motion.p>
          ...
          <div>
            ...
            <div className="space-y-4">
              {[
                ...
                { icon: Play,    label: 'YouTube',     value: 'kolab Channel' },
