        ...
        <div className="grid gap-12 md:grid-cols-2">
          <motion.div initial="hidden" whileInView="show" viewport={VP} variants={stagger()}>
            ...
            <motion.div variants={fadeUp} className="mt-6 flex flex-wrap gap-x-6 gap-y-2 text-sm text-white/60">
              <Link to="/privacy" className="transition-colors hover:text-white">{d.footer.privacy}</Link>
              <Link to="/terms" className="transition-colors hover:text-white">{d.footer.terms}</Link>
              <Link to="/support" className="transition-colors hover:text-white">{d.footer.support}</Link>
            </motion.div>
          </motion.div>
