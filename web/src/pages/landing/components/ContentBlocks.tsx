      ...
      {items.map((item, i) => {
        ...
        return (
          <motion.div
            ...
            className="group rounded-2xl border border-ink/10 bg-white p-5 shadow-[0_2px_10px_rgba(20,17,16,0.04)] transition-shadow duration-300 hover:shadow-[0_16px_32px_-14px_rgba(20,17,16,0.12)] dark:border-white/10 dark:bg-ink-elevated dark:shadow-none"
          >
