...
exports.createCampaignSchema = zod_1.z.object({
    ...
    platform: zod_1.z.string().default(''),
    ...
    budgetMin: zod_1.z.number().min(0, 'Budget minimum must be non-negative').default(0),
    budgetMax: zod_1.z.number().min(0, 'Budget maximum must be non-negative').default(0),
    paymentType: zod_1.z.string().default('Fixed Fee'),
    creatorsNeeded: zod_1.z.number().int().positive().default(1),
    isFeatured: zod_1.z.boolean().optional().default(false),
    campaignType: zod_1.z.enum(['PAID_CAMPAIGN', 'OPEN_EVENT']).default('PAID_CAMPAIGN'),
...
exports.updateCampaignSchema = zod_1.z.object({
    ...
    campaignType: zod_1.z.enum(['PAID_CAMPAIGN', 'OPEN_EVENT']).optional(),
    capacity: zod_1.z.number().int().positive().optional(),
    eventDate: zod_1.z.string().datetime().optional(),
    venue: zod_1.z.string().optional(),
    benefits: zod_1.z.array(zod_1.z.string()).optional(),
    eventStatus: zod_1.z.enum(['OPEN', 'FULL', 'CLOSED']).optional(),
});
...
exports.applyToCampaignSchema = zod_1.z.object({
    ...
    proposedRate: zod_1.z.number().min(0, 'Proposed rate must be non-negative').default(0),
