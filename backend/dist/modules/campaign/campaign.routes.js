...
const ctrl = new campaign_controller_1.CampaignController();
/**
 * @swagger
 * /api/campaigns:
 *   post:
 ...
 */
router.post('/', auth_1.authenticate, (0, auth_1.authorize)('BUSINESS'), (0, validate_1.validate)(campaign_schema_1.createCampaignSchema), ctrl.create.bind(ctrl));
/**
 * @swagger
 * /api/campaigns:
 *   get:
 ...
 *               $ref: '#/components/schemas/PaginatedResponse'
 */
router.get('/my', auth_1.authenticate, (0, auth_1.authorize)('BUSINESS'), ctrl.getMyCampaigns.bind(ctrl));
/**
 * @swagger
 ...
 *         description: Campaign not found
 */
router.put('/:id', auth_1.authenticate, (0, auth_1.authorize)('BUSINESS'), (0, validate_1.validate)(campaign_schema_1.updateCampaignSchema), ctrl.update.bind(ctrl));
/**
 * @swagger
 * /api/campaigns/{id}:
 *   delete:
 ...
 *         description: Campaign not found
 */
router.delete('/:id', auth_1.authenticate, (0, auth_1.authorize)('BUSINESS'), ctrl.delete.bind(ctrl));
/**
 * @swagger
 ...
 *               $ref: '#/components/schemas/PaginatedResponse'
 */
router.get('/:id/applications', auth_1.authenticate, (0, auth_1.authorize)('BUSINESS'), ctrl.getCampaignApplications.bind(ctrl));
/**
 * @swagger
 ...
 *                   $ref: '#/components/schemas/Application'
 */
router.put('/:id/applications/:appId/accept', auth_1.authenticate, (0, auth_1.authorize)('BUSINESS'), ctrl.acceptApplication.bind(ctrl));
/**
 * @swagger
 ...
 *                   $ref: '#/components/schemas/Application'
 */
router.put('/:id/applications/:appId/reject', auth_1.authenticate, (0, auth_1.authorize)('BUSINESS'), ctrl.rejectApplication.bind(ctrl));
