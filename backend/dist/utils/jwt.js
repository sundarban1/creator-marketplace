...
function signPasswordResetToken(payload) {
    return jsonwebtoken_1.default.sign(payload, env_1.env.JWT_ACCESS_SECRET + '_reset', {
        expiresIn: '1h',
    });
}
function verifyPasswordResetToken(token) {
    return jsonwebtoken_1.default.verify(token, env_1.env.JWT_ACCESS_SECRET + '_reset');
}
