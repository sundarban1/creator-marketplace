-- Re-restores the trigram/full-text indexes yet again — every migration in
-- this session that touches an unrelated column keeps regenerating the same
-- 4 stray "DropIndex" statements described in
-- 20260814130000_restore_search_indexes. IF NOT EXISTS makes this safe
