...
export const ActivityAction = {
  ...
  CREATOR_CONFIRMATION_EXPIRED: 'application.confirmation_expired',
  CONTENT_OVERDUE:            'application.content_overdue',
  CREATOR_FAILED:             'application.creator_failed',
  BUSINESS_REVIEW_AUTO_APPROVED: 'application.review_auto_approved',
