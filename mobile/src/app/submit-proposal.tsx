...
const TEMPLATES: Record<string, string[]> = {
  Fashion: [
    `Hi {brand} team!\n\nI'm thrilled to apply for the "{title}" campaign. As a fashion content creator, I specialize in building authentic styling narratives that resonate with trend-conscious audiences.\n\nMy followers trust my honest reviews and aesthetic-first approach, and I'm confident I can showcase your brand in a way that feels both genuine and aspirational.\n\nLooking forward to the opportunity to collaborate!`,
    `Hello {brand}!\n\nThe "{title}" campaign immediately caught my eye. Fashion storytelling is my passion — I craft visually compelling content that drives real engagement among style enthusiasts.\n\nI have a strong track record of working with clothing and lifestyle brands to produce content that converts. I'd love to bring that same energy to this campaign.\n\nExcited to hear from you!`,
  ],
  Food: [
    ...
    `Hello {brand}!\n\nThe "{title}" campaign looks right up my alley. As a food creator, I turn every dish into a story — showcasing flavors in a way that feels personal and authentic.\n\nMy engaged foodie audience actively seeks out recommendations, and I'd love to introduce your brand to them in an organic, meaningful way.\n\nCan't wait to collaborate!`,
  ],
  Tech: [
    `Hi {brand} team!\n\nI'm applying for the "{title}" campaign with genuine enthusiasm. As a tech creator, I break down complex products into clear, relatable content that helps everyday users make smart decisions.\n\nMy audience values my honest, in-depth approach, and I believe a hands-on review or tutorial collaboration would work perfectly for this campaign.\n\nLooking forward to working together!`,
  ...
  Technology: [
    ...
    `Hello {brand}!\n\nThe "{title}" campaign is a great match for my content style. I specialize in making technology feel accessible and exciting, whether through tutorials, unboxings, or comparison videos.\n\nI'd love to leverage my engaged audience to showcase your brand authentically.\n\nThank you for the opportunity!`,
  ],
  Beauty: [
    ...
    `Hello {brand}!\n\nThe "{title}" campaign is exactly the kind of collaboration I look for. As a beauty creator, I believe in honest storytelling — my audience knows my reviews are real, which is why they keep coming back.\n\nI'd love to incorporate your brand into my routine content in a way that feels genuine and resonates deeply.\n\nLooking forward to this partnership!`,
  ],
  Travel: [
    ...
    `Hello {brand}!\n\nThe "{title}" campaign immediately inspired me. As a travel creator, I specialize in showcasing experiences in a way that makes my audience want to book their next trip right away.\n\nI'd love to weave your brand into my travel content seamlessly — making it feel like a natural part of the adventure.\n\nLooking forward to hearing from you!`,
  ],
  Fitness: [
  ...
  Gaming: [
    ...
    `Hello {brand}!\n\nThe "{title}" campaign looks like an epic collaboration. As a gaming creator, I understand what resonates with the gaming community — authenticity, humor, and skill.\n\nI'd love to integrate your brand naturally into my content, whether through gameplay, reviews, or creative storytelling.\n\nLooking forward to connecting!`,
  ],
  Music: [
    ...
    `Hello {brand}!\n\nThe "{title}" campaign resonates with me deeply. As a music creator, I understand how to tell stories that move people — and I believe that same emotional connection can make your brand unforgettable.\n\nI'd love to bring my creative vision to this campaign in a way that feels authentic to my audience.\n\nLooking forward to collaborating!`,
  ],
  Education: [
    ...
    `Hello {brand}!\n\nThe "{title}" campaign is a great match for my educational content approach. I specialize in creating content that informs, empowers, and builds lasting trust with my audience.\n\nI'd love to authentically integrate your brand into my tutorials or explainer content in a way that adds real value.\n\nLooking forward to this opportunity!`,
  ],
  Lifestyle: [
    ...
    `Hello {brand}!\n\nThe "{title}" campaign is exactly my type of collaboration. As a lifestyle creator, I'm passionate about showing my audience how to live better — and great brands are a big part of that story.\n\nI'd love to integrate your product into my content in a way that feels organic and compelling.\n\nExcited about this opportunity!`,
  ],
  Sports: [
    ...
    `Hello {brand}!\n\nThe "{title}" campaign is a great fit for my sports-focused content. I specialize in creating content that celebrates athleticism and inspires peak performance.\n\nI'd love to showcase your brand alongside my training content in a way that resonates with competitive athletes and sports enthusiasts.\n\nLooking forward to this partnership!`,
  ],
  Wellness: [
    ...
    `Hello {brand}!\n\nThe "{title}" campaign aligns beautifully with my wellness philosophy. As a wellness creator, I believe in sharing only what I genuinely use and believe in — and that's what makes my audience trust my recommendations.\n\nI'd love to weave your brand into my content in a way that promotes genuine well-being.\n\nExcited to connect!`,
  ],
};

const DEFAULT_TEMPLATES = [
  `Hi {brand} team!\n\nI'm excited to apply for the "{title}" campaign. I believe my content style and engaged audience are a great fit for what you're looking for.\n\nI'm passionate about creating authentic content that genuinely resonates with my followers, and I'd love to bring that energy to this collaboration.\n\nLooking forward to discussing this opportunity with you!`,
  `Hello {brand}!\n\nI came across the "{title}" campaign and immediately knew I had to apply. My content is built on authenticity and genuine audience connection, which I believe aligns well with your brand's goals.\n\nI have a track record of creating engaging content that drives real results, and I'd be thrilled to bring those skills to this campaign.\n\nExcited about the possibility of working together!`,
...
function generateTemplate(category: string, title: string, brand: string): string {
  ...
  return pool[idx]
    ...
    .replace(/\{title\}/g, title || 'this campaign');
}

// ─── Screen ───────────────────────────────────────────────────────────────────

export default function SubmitProposalScreen() {
  const { campaignId, campaignTitle, brand, budget, category } = useLocalSearchParams<{
    campaignId:    string;
