...
const styles = StyleSheet.create({
  ...
  stepNum: { fontSize: 12, fontWeight: '700', textTransform: 'uppercase', letterSpacing: 1, marginBottom: 4 },
  stepTitle: { fontSize: 24, fontWeight: '800' },
  stepSubtitle: { fontSize: 14, lineHeight: 20, marginTop: 4 },
  ...
  maxReachedText: { fontSize: 12, fontWeight: '600' },
  ...
  categoryCheck: { fontSize: 11, fontWeight: '800' },
  form: { gap: 16, marginBottom: 28 },
  formGroup: { gap: 6 },
  formLabel: { fontSize: 13, fontWeight: '700' },
  formInput: { borderRadius: 12, borderWidth: 1.5, paddingHorizontal: 14, paddingVertical: 13, fontSize: 15 },
  ...
  atSign: { fontSize: 16, fontWeight: '700', marginRight: 2 },
  usernameInput: { flex: 1, fontSize: 15, paddingVertical: 13 },
  usernameLimit: { fontSize: 11 },
  ...
  finishNote: { textAlign: 'center', fontSize: 12, marginTop: 4 },
  ...
  checkMark: { fontSize: 52, color: '#fff', fontWeight: '700', lineHeight: 62 },
