...
const styles = StyleSheet.create({
  ...
  input: { borderRadius: 12, borderWidth: 1.5, paddingHorizontal: 14, paddingVertical: 13, fontSize: 15 },
  textarea: { minHeight: 120, paddingTop: 13, textAlignVertical: 'top' },
  inputHint: { fontSize: 11, marginTop: 5 },
  ...
  maxBannerText: { fontSize: 13, fontWeight: '600' },
  ...
  chipCheck: { fontSize: 10, fontWeight: '800' },
  ...
  finishNote: { textAlign: 'center', fontSize: 12 },
