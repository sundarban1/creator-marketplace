...
const COMPOSER_ACCESSORY_ID = 'creatorChatComposer';
...
function MessageBubble({
  ...
  // payment released). Always centered, sender-less — isSent/showAvatar/
  // personName etc. are irrelevant for these regardless of who technically
  // sent them server-side.
  if (msg.type === 'SYSTEM') {
    return (
...
const s = StyleSheet.create({
  ...
  // Header
  header:          { flexDirection: 'row', alignItems: 'center', paddingHorizontal: SCREEN_GUTTER, paddingVertical: SPACING.md, gap: 10, borderBottomWidth: 1 },
  ...
  // Request bar
  requestBar:        { paddingHorizontal: SCREEN_GUTTER, paddingVertical: 12, borderBottomWidth: 1, gap: 10 },
