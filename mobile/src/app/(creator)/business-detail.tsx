...
const styles = StyleSheet.create({
  ...
  heroStatLabel:         { fontSize: 10, fontWeight: '600', textTransform: 'uppercase', marginTop: 1 },
  ...
  campaignsSectionTitle: { fontSize: 17, fontWeight: '800' },
  ...
  noCampaignsTitle:      { fontSize: 16, fontWeight: '700' },
  noCampaignsSub:        { fontSize: 13, textAlign: 'center', lineHeight: 20 },
  ...
  appliedPillText:       { fontSize: 11, fontWeight: '700', color: '#059669' },
  ...
  applyNowBtnText:       { fontSize: 11, fontWeight: '700', color: '#fff' },
});
