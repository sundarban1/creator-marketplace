...
export default function CreatorDetailScreen() {
  ...
  // Referenced only by the commented-out "Send Message Request" button in the
  // sticky action bar below — kept so restoring that button is a pure uncomment.
  ...
  return (
    <SafeAreaView style={[s.container, { backgroundColor: C.background }]} edges={['top']}>
      ...
      {/* Sticky action bar. The "Send Message Request" button (the else branch
          below, onPress={openRequestModal}) is commented out for now — business
          users cannot initiate message requests to creators. The bar still
