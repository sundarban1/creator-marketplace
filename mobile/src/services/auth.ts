...
import { ACCESS_TOKEN_KEY, REFRESH_TOKEN_KEY, USER_KEY, BIOMETRIC_ENABLED_KEY, RECENT_SEARCHES_KEY } from '@/utilities/constants';
...
export const authService = {
  ...
  async getStoredUser(): Promise<User | null> {
    await storage.hydrate([ACCESS_TOKEN_KEY, REFRESH_TOKEN_KEY, USER_KEY, BIOMETRIC_ENABLED_KEY, RECENT_SEARCHES_KEY]);
