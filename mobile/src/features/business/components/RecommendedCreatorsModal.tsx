...
const s = StyleSheet.create({
  ...
  sentText: { fontSize: 16, fontWeight: '700', fontFamily: F.bold },
  ...
  skipBtnText: { color: '#fff', fontSize: 13, fontWeight: '700', fontFamily: F.bold },

  selectAllRow: { flexDirection: 'row', alignItems: 'center', gap: 10, paddingHorizontal: 20, paddingVertical: 12 },
  selectAllText: { fontSize: 13, fontWeight: '700', fontFamily: F.bold, flex: 1 },
  selectedCount: { fontSize: 12, fontWeight: '700', fontFamily: F.bold },
  ...
  avatarText: { color: '#fff', fontSize: 13, fontWeight: '700', fontFamily: F.bold },
  info: { flex: 1, gap: 3 },
  name: { fontSize: 14, fontWeight: '700', fontFamily: F.bold },
  metaRow: { flexDirection: 'row', alignItems: 'center', gap: 6, flexWrap: 'wrap' },
  sub: { fontSize: 12, fontFamily: F.regular },
  distanceTag: { flexDirection: 'row', alignItems: 'center', gap: 2 },
  distanceText: { fontSize: 11, fontWeight: '700', fontFamily: F.bold },
  ...
  skipLinkText: { fontSize: 13, fontWeight: '600', fontFamily: F.semibold },
  inviteBtn: { flex: 1, borderRadius: 12, paddingVertical: 12, alignItems: 'center' },
  inviteBtnText: { color: '#fff', fontSize: 14, fontWeight: '700', fontFamily: F.bold },
});
